...
if inv_type == "joint"
    ...
    tight_layout()
    safesave(joinpath(plot_path, "sol_nrep_"*savename(fig_name; digits=6)*"_6Vintages.png"), fig);
    ...
    tight_layout()
    safesave(joinpath(plot_path, "sol_nrep_"*savename(fig_name; digits=6)*"_6Vintages_commInnovComp.png"), fig);
    ...
    tight_layout()
    safesave(joinpath(plot_path, "sol_nrep_"*savename(fig_name; digits=6)*"_6Vintages_time-lapse.png"), fig);
